...
const testCases: TestCase[] = [
  ...
  },
  {
    ...
    output: s => [
      ...
      new Token(kinds.and, s(16, 1)),
      new Token(kinds.pipe, s(17, 1)),
      new Token(kinds.end, s(18, 0))
    ]
  },
  {
    ...
    output: s => [
      ...
      new Token(kinds.andAnd, s(12, 2)),
      new Token(kinds.pipePipe, s(15, 2)),
      new Token(kinds.end, s(17, 0))
    ]
  },
  {
